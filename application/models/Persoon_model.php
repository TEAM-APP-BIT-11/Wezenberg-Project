...
class Persoon_model extends CI_Model {
	...
	*/
	...
	/*
	* Update het record in de tabel afstand met de id die uit $persoon gehaald wordt
	...
	*/
	...
	/*
	* Voegt een nieuw record afstand=$persoon', $persoon toe in de tabel persoon', $persoon
